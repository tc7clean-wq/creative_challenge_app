-- Graceful database fix - handles existing policies and tables
...
DROP POLICY IF EXISTS "Users can view their own jackpot entries" ON public.jackpot_entries;
DROP POLICY IF EXISTS "Users can insert their own jackpot entries" ON public.jackpot_entries;
DROP POLICY IF EXISTS "Admins can do everything on jackpot_entries" ON public.jackpot_entries;

DROP POLICY IF EXISTS "Users can view all jackpot draws" ON public.jackpot_draws;
DROP POLICY IF EXISTS "Admins can do everything on jackpot_draws" ON public.jackpot_draws;
