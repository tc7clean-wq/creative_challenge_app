-- Clean database setup - run this to fix all issues
...
-- 7. Create jackpot_entries table
...
-- 15. Create RLS policies for submissions
...
-- 16. Create RLS policies for votes
